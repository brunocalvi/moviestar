        ...
        <div class="row"> 
          <div class="col-md-4">
            ...
            <div class="form-group">
              ...
              <input type="email" class="form-control disabled" id="email" name="email" placeholder="Digite seu e-mail" readonly value="<?php echo $userData->email ?>">
            </div>
            <input type="submit" class="btn form-btn" value="Alterar">
          </div>
          <div class="col-md-4">
            <div id="profile-image-container" style="background-image: url('<?php echo $BASE_URL . $userData->image ?>')"></div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" id="bio" name="bio" rows="5" placeholder="Conte quem você é, o que faz, onde trabalha..."><?php echo $userData->bio ?></textarea>
            </div>
          </div>    
        </div> 
      </form> 
