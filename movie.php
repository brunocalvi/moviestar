...
<div id="main-container" class="container-fluid">
  <div class="row">
    <div class="offset-md-1 col-md-6 movie-container">
      ...
      <iframe width="560" height="315" src="<?php echo $movie->trailer ?>" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      <p><?php echo $movie->description ?></p>
    </div>
    <div class="col-md-4">
      <?php if(!empty($movie->image)): ?>
        <div class="movie-image-container" style="background-image: url('<?php echo $BASE_URL . $movie->image ?>'); min-height: 250px;"></div>
      <?php else: ?>
    ...
    <div class="offset-md-1 col-md-10" id="reviews-container">
      ...
      <?php if(!empty($userData) && !$userOwnsMovie && !$alreadyReviewed): ?>  
        <div class="col-md-12" id="review-form-container">
          ...
          <form action="<?php echo $BASE_URL ?>review_process.php" method="POST">
