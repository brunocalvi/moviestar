  ...
  <div class="col-md-12">
    <div class="row"> 
      <div class="col-md-6 offset-md-1">
        ...
        <form id="add-movie-form" action="<?php echo $BASE_URL ?>movie_process.php" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group">
              ...
              <select class="form-control" name="category" id="cateogry">
                  ...
                  <option value="Comedia"<?php echo $movie->category === "Comedia" ? "selected" : "" ?>>Comedia</option>
          ...
          <div class="form-group">
              ...
              <textarea class="form-control" name="description" id="description" rows="5"><?php echo $movie->description ?></textarea>
          </div>
      ...
      <div class="col-md-3">
        <?php if(!empty($movie->image)): ?>
          <div class="movie-image-container" style="background-image: url('<?php echo $BASE_URL . $movie->image ?>')"></div>
        <?php else: ?>
